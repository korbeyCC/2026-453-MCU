...
#define PID_DEFAULT_OUT_MAX     200.0f  // 默认输出限幅 (RPM)
#define PID_DEFAULT_OUT_MIN     -200.0f // 默认输出下限 (RPM)
#define PID_DEFAULT_IOUT_MAX    30.0f   // 默认积分限幅 (RPM)

#define PID_DIFF_LOW_THRESHOLD  50.0f   // PID 动态限幅低偏差门限 (counts, 约 0.44mm)
#define PID_DIFF_HIGH_THRESHOLD 1900.0f // PID 动态限幅高偏差门限 (counts, 约 3.55mm, 适度放大避免过早进入大限幅)
